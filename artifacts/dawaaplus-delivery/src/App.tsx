...
function RegisterForm({ color, onBack }:{ color:string; onBack:()=>void }) {
  ...
  return (
    <>
      <h2 style={{ textAlign:"center",fontSize:17,fontWeight:800,margin:"0 0 18px" }}>📋 طلب تسجيل شركة توصيل جديدة</h2>
      <label style={{ fontSize:12,fontWeight:700,display:"block",marginBottom:4 }}>اسم الشركة *</label>
      <input style={inp} placeholder="مثال: شركة السرعة للتوصيل" value={f.name} onChange={upd("name")} />
      ...
      <label style={{ fontSize:12,fontWeight:700,display:"block",marginBottom:4 }}>رقم رخصة العمل</label>
      <input style={inp} placeholder="مثال: DL-2024-001 (اختياري)" value={f.license} onChange={upd("license")} />
