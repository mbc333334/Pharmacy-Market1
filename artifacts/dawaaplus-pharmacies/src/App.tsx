  ...
  return (
    <div style={{ background:"#fff",borderBottom:`1px solid ${C.border}`,padding:"0 20px",height:56,display:"flex",alignItems:"center",gap:12,flexShrink:0 }}>
      ...
      <div style={{ display:"flex",alignItems:"center",gap:8 }}>
        <button onClick={copy} title="نسخ رابط المنصة" style={{ background:copied?"#F0FFF4":"#EDF2F7",border:`1px solid ${copied?C.green:C.border}`,borderRadius:8,padding:"5px 10px",fontSize:11,cursor:"pointer",fontWeight:700,color:copied?C.green:C.text }}>
          {copied?"✅ تم":  "🔗 الرابط"}
        </button>
